...
FeXANES= {'high_e':7.5, 'low_e':7.1,
          'high_e_zpz1':2.90, 'zpz1_slope':-5.04,
          'energy':[(7.05,7.11,0.005),(7.111,7.150,0.001),(7.155,7.42,0.005)],
...
def peak_the_flux():
    ...
    yield from peak_b_bpm(bbpm_y,-5,5,10)
    yield from bps.sleep(1)
    yield from peak_b_bpm(bbpm_x,15,15,6)
    yield from bps.sleep(1)
    yield from peak_b_bpm(bbpm_y,-2,2,4)
