...
##########################################
# Following section for setting up CompositeBroker is moved to hxntools package.
##########################################
...
# Use CompositeBroker from hxntools to be consistent with data loading software
from hxntools.CompositeBroker import kafka_publisher,db
